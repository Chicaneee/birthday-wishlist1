...
const targets = [
  {
    ...
    monoJarUrl: "https://send.monobank.ua/jar/8XgNRaWTgg",
    reservable: false,
  },
  {
    id: "handmade-gift",
  ...
  {
    id: "horse-themed-gift",
    title: "Что-то с конями",
    tag: "с лошадьми",
    price: 0,
    priceLabel: "любой вариант",
    collected: 0,
    currency: "UAH",
    image: "assets/horse-themed-gift.jpg?v=20260825",
    description: "Футболка, аксессуар, украшение или любая другая вещь с лошадьми. Не обязательно именно такая, как на фото.",
    quickAmounts: [300, 500, 1000],
    reservable: true,
  },
  {
  ...
  {
    id: "room-decor",
    title: "Красивый декор в комнату",
    tag: "для уюта",
    price: 0,
    priceLabel: "любой вариант",
    collected: 0,
    currency: "UAH",
    image: "assets/room-decor.jpg?v=20260825",
    description: "Светящиеся веточки, гирлянда или другой красивый декор, который добавит комнате уюта.",
    quickAmounts: [300, 500, 1000],
    reservable: true,
  },
  {
